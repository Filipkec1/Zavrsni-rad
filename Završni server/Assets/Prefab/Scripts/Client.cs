...
public class Client
{
    ...
    public class TCP
    {
        ...
        public void Connect(TcpClient _socket)
        {
            ...
            ServerSend.Welcome(id, "Welcome to the server!", true);
        }
    ...
    public void SendIntoGame(string _playerName)
    {
        ...
        // Send the new itemspawner to all players
        ...
        // Send the new healthSpawner to all players
        foreach (HealthSpawner _healthSpawner in HealthSpawner.healthSpawners.Values)
        {
            ServerSend.CreateHealthSpawner(id, _healthSpawner.healthSpawnerId, _healthSpawner.transform.position, _healthSpawner.hasHealth);
        }
    }
